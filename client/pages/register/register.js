...
Page({
  ...
  onLoad:function(){
    ...
    wx.request({
      ...
      url: 'http://salon.hiter-lab.cn/salon/school.php',
      method: "GET",
      header: {
    ...
    wx.request({
      ...
      url: 'http://salon.hiter-lab.cn/salon/profession.php',
      method: "GET",
      header: {
        'content-type': 'application/x-www-form-urlencoded'
      },
    ...
    wx.request({
      ...
      url: 'http://salon.hiter-lab.cn/salon/characteristic.php',
      method: "GET",
      header: {
        'content-type': 'application/x-www-form-urlencoded'
      },
  ...
  */
  username:function(e){
    ...
    wx.request({
      ...
      url: 'http://salon.hiter-lab.cn/salon/useful_name.php', 
      method: "POST",
      data: {
        user_name: userName,
      },
  ...
  register:function(){
    ...
    wx.request({
      ...
      url: 'http://salon.hiter-lab.cn/salon/register.php',
      data: {
